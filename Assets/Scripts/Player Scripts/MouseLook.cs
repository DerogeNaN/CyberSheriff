...
public class MouseLook : MonoBehaviour
{
    ...
    public void UpdateMouse()
    {
        ...
        cam.transform.localEulerAngles = new Vector3(currRotationX, 0.0f, cam.transform.localEulerAngles.z + RevCam.transform.localEulerAngles.z);    //Assign new mouse input value to camera transform
